...
CREATE TABLE usuarios_plataforma (
    ...
    telefono VARCHAR(30) NULL,
    rol ENUM('superadmin','soporte_plataforma','visualizador_plataforma','programador') NOT NULL DEFAULT 'superadmin',
    modulos_asignados JSON NULL COMMENT 'Array JSON de códigos de módulo asignados. Solo aplica para rol=programador. Ej: ["m.catalogo","m.devoluciones"]',
    esta_activo TINYINT(1) NOT NULL DEFAULT 1,
...
CREATE TABLE ordenes_compra (
    ...
    incluir_igv BOOLEAN DEFAULT TRUE,
    ...
    CONSTRAINT fk_ordcom_usuario FOREIGN KEY (usuario_id) REFERENCES usuarios(id),
