 ...
 * Muestra las devoluciones asociadas a ventas (clientes finales).
 */
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Gestiona las devoluciones asociadas a ventas realizadas a clientes
          </p>
        </div>
      ...
      <Card>
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-12 text-gray-400">
            <RotateCcw size={40} className="mb-3" />
            <p className="font-medium">No se encontraron devoluciones de clientes</p>
      ...
      <Modal
        ...
        title="Registrar Devolución de Cliente"
        maxWidth="lg"
      >
